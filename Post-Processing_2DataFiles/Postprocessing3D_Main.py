...
#in counts.txt
with open("Data_1.txt", "r",encoding='latin-1') as input_file:
...
with open("Data_2.txt", "r",encoding='latin-1') as input_file:
...
amps_id_vector=[1,5,6,8,17,20] # ID of the amplifiers used
amps_id_handshake = 8 # ID of detector used for the handshake
t=420 # Total time in minutes
