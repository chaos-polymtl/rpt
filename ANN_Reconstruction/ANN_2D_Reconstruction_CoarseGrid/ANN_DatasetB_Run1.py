...
filename_counts = 'interpolaited_counts_all_datasetB.txt'
...
filename_pos = 'x_y_robot_position_datasetB.txt'
data_pos = np.loadtxt(filename_pos, delimiter=',')


Feed[:,4] = (data_pos[0:NUM_TP, 0]-669.984)/1000
Feed[:,5] = (data_pos[0:NUM_TP, 1]--199.476)/1000
